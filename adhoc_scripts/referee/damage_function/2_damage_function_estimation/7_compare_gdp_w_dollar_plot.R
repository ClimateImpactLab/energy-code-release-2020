...
data = read_csv("/mnt/CIL_energy/code_release_data_pixel_interaction/referee_comments/damage_function_estimation/percent_gdp_vs_dollar_df_comparison.csv")
...
ggsave(p, file = '/home/liruixue/repos/energy-code-release-2020/figures/referee_comments/percent_gdp_vs_dollar_df_comparison_gradient.pdf')

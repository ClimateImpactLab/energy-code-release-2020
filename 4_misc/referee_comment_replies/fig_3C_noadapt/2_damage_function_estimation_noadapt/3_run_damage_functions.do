...
foreach price in `pricelist' {
	di "`price'"
	import delim "$dir/impact_values/gcm_damages_OTHERIND_total_energy_`price'_`ssp'`model_tag'_noadapt.csv", clear
...
outsheet using "$dir/coefficients/df_mean_output_`ssp'`model_tag'_noadapt.csv", comma replace	

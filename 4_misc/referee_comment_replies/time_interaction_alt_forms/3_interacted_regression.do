...
foreach submodel in "plininter" "decinter" "p80elecinter" "coldsidep80" "coldside" "twosidedp80" "coldsidepwl" { 
...
//	do $root/4_misc/referee_comment_replies/time_interaction_alt_forms/interacted_regression/plot_stacked_decinter.do
	foreach submodel in "p80elecinter" "coldsidep80" "coldside" "twosidedp80" "coldsidepwl" {
		global submodel "`submodel'"
